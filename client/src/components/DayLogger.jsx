...
import Firework from './parts/Firework.jsx';
...
export default function DayLogger() {
    ...
    const save = () => {
        if(!saved){
            if(Object.values(day).every(value => value !== null)) setLaunch(true)
            saveData()
            setSaved(true)
            setTempDay(day)
        }
    ...
    return (
        <div className="relative">
            <div className="relative p-5 text-stone-500 dark:text-white z-10">Log Day For:
                <input
                    type="date"
